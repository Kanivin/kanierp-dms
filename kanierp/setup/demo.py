...
def setup_demo_data():
	...
	capture("demo_data_creation_started", "kanierp")
	try:
		...
		capture("demo_data_creation_failed", "kanierp", properties={"exception": frappe.get_traceback()})
		raise
	capture("demo_data_creation_completed", "kanierp")
...
def clear_demo_data():
	...
	capture("demo_data_erased", "kanierp")
	try:
...
def make_transactions(company):
	...
	from kanierp.accounts.utils import FiscalYearError

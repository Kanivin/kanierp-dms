...
from kanierp.buying.doctype.request_for_quotation.request_for_quotation import (
	RequestforQuotation,
	create_supplier_quotation,
	get_pdf,
	make_supplier_quotation_from_rfq,
)
from kanierp.crm.doctype.opportunity.opportunity import make_request_for_quotation as make_rfq
from kanierp.crm.doctype.opportunity.test_opportunity import make_opportunity
from kanierp.stock.doctype.item.test_item import make_item
from kanierp.templates.pages.rfq import check_supplier_has_docname_access


class TestRequestforQuotation(KanivinTestCase):

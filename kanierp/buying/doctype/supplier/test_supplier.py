...
from kanierp.controllers.website_list_for_contact import get_customers_suppliers
from kanierp.exceptions import PartyDisabled
...
class TestSupplier(KanivinTestCase):
...
class TestSupplierPortal(KanivinTestCase):

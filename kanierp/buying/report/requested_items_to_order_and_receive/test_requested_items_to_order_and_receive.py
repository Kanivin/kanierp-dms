...
from kanierp.buying.report.requested_items_to_order_and_receive.requested_items_to_order_and_receive import (
	get_data,
)
...
class TestRequestedItemsToOrderAndReceive(KanivinTestCase):
	def setUp(self) -> None:

...
class QualityMeeting(Document):
	...
	if TYPE_CHECKING:
		...
		from kanierp.quality_management.doctype.quality_meeting_agenda.quality_meeting_agenda import (
			QualityMeetingAgenda,
		)
		from kanierp.quality_management.doctype.quality_meeting_minutes.quality_meeting_minutes import (

...
from kanierp.manufacturing.doctype.routing.test_routing import create_routing, setup_bom
from kanierp.manufacturing.doctype.workstation.workstation import (
...
class TestWorkstation(KanivinTestCase):

...
frappe.ui.form.on("Workstation", {
	...
	onload(frm) {
		if (frm.is_new()) {
			frappe.call({
				type: "GET",
				method: "kanierp.manufacturing.doctype.workstation.workstation.get_default_holiday_list",
				callback: function (r) {
					if (!r.exe && r.message) {
...
class WorkstationDashboard {
	...
	prepapre_dashboard() {
		frappe.call({
			method: "kanierp.manufacturing.doctype.workstation.workstation.get_job_cards",
			args: {

...
from kanierp.manufacturing.doctype.bom.bom import BOMRecursionError, item_query, make_variant_bom
from kanierp.manufacturing.doctype.bom_update_log.test_bom_update_log import (
...
class TestBOM(KanivinTestCase):
	...
	def test_get_items_list(self):
		from kanierp.manufacturing.doctype.bom.bom import get_bom_items
	...
	def test_do_not_include_manufacturing_and_fixed_items(self):
		from kanierp.manufacturing.doctype.bom.bom import item_query
	...
	def test_get_scrap_items_from_sub_assemblies(self):
		from kanierp.manufacturing.doctype.bom.bom import get_scrap_items_from_sub_assemblies

...
from kanierp.manufacturing.doctype.work_order.work_order import make_stock_entry as make_se_from_wo
...
class TestProductionPlan(KanivinTestCase):
	def setUp(self):
		for item in [
	...
	def test_production_plan_for_subcontracting_po(self):
		from kanierp.manufacturing.doctype.bom.test_bom import create_nested_bom
		from kanierp.subcontracting.doctype.subcontracting_bom.test_subcontracting_bom import (

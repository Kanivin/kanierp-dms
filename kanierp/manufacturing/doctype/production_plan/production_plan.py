...
from kanierp.manufacturing.doctype.bom.bom import get_children as get_bom_children
from kanierp.manufacturing.doctype.bom.bom import validate_bom_no
from kanierp.manufacturing.doctype.work_order.work_order import get_item_details
from kanierp.setup.doctype.item_group.item_group import get_item_group_defaults
from kanierp.stock.get_item_details import get_conversion_factor
from kanierp.stock.utils import get_or_make_bin
from kanierp.utilities.transaction_base import validate_uom_is_integer
...
class ProductionPlan(Document):
	...
	if TYPE_CHECKING:
		...
		from kanierp.manufacturing.doctype.material_request_plan_item.material_request_plan_item import (
			MaterialRequestPlanItem,
		)
		from kanierp.manufacturing.doctype.production_plan_item.production_plan_item import ProductionPlanItem
		from kanierp.manufacturing.doctype.production_plan_item_reference.production_plan_item_reference import (
			ProductionPlanItemReference,
		)
		from kanierp.manufacturing.doctype.production_plan_material_request.production_plan_material_request import (
			ProductionPlanMaterialRequest,
		)
		from kanierp.manufacturing.doctype.production_plan_material_request_warehouse.production_plan_material_request_warehouse import (
			ProductionPlanMaterialRequestWarehouse,
		)
		from kanierp.manufacturing.doctype.production_plan_sales_order.production_plan_sales_order import (
			ProductionPlanSalesOrder,
		)
		from kanierp.manufacturing.doctype.production_plan_sub_assembly_item.production_plan_sub_assembly_item import (
	...
	def make_work_order(self):
		from kanierp.manufacturing.doctype.work_order.work_order import get_default_warehouse
	...
	def create_work_order(self, item):
		from kanierp.manufacturing.doctype.work_order.work_order import OverProductionError
...
def get_materials_from_other_locations(item, warehouses, new_mr_items, company):
	from kanierp.stock.doctype.pick_list.pick_list import get_available_item_locations
...
def get_reserved_qty_for_production_plan(item_code, warehouse):
	from kanierp.manufacturing.doctype.work_order.work_order import get_reserved_qty_for_production

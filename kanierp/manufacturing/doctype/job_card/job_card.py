...
from kanierp.manufacturing.doctype.workstation_type.workstation_type import get_workstations
...
class JobCard(Document):
	...
	if TYPE_CHECKING:
		...
		from kanierp.manufacturing.doctype.job_card_item.job_card_item import JobCardItem
		from kanierp.manufacturing.doctype.job_card_operation.job_card_operation import JobCardOperation
		from kanierp.manufacturing.doctype.job_card_scheduled_time.job_card_scheduled_time import (
			JobCardScheduledTime,
		)
		from kanierp.manufacturing.doctype.job_card_scrap_item.job_card_scrap_item import JobCardScrapItem
		from kanierp.manufacturing.doctype.job_card_time_log.job_card_time_log import JobCardTimeLog

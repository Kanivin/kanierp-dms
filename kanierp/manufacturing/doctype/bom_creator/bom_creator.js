...
frappe.ui.form.on("BOM Creator", {
	...
	make_new_entry(frm) {
		...
		dialog.fields_dict.item_code.get_query = "kanierp.controllers.queries.item_query";
		dialog.show();
	},
...
kanierp.bom.BomConfigurator = class BomConfigurator extends kanierp.TransactionController {
	conversion_rate(doc) {
...
extend_cscript(cur_frm.cscript, new kanierp.bom.BomConfigurator({ frm: cur_frm }));

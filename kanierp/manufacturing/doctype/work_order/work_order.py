...
from kanierp.manufacturing.doctype.manufacturing_settings.manufacturing_settings import (
	get_mins_between_operations,
)
from kanierp.stock.doctype.batch.batch import make_batch
from kanierp.stock.doctype.item.item import get_item_defaults, validate_end_of_life
from kanierp.stock.doctype.serial_no.serial_no import get_available_serial_nos, get_serial_nos
from kanierp.stock.stock_balance import get_planned_qty, update_bin_qty
from kanierp.stock.utils import get_bin, get_latest_stock_qty, validate_warehouse_company
...
class WorkOrder(Document):
	...
	if TYPE_CHECKING:
		...
		from kanierp.manufacturing.doctype.work_order_item.work_order_item import WorkOrderItem
		from kanierp.manufacturing.doctype.work_order_operation.work_order_operation import (
			WorkOrderOperation,
		)
	...
	def update_work_order_qty(self):
		...
		for purpose, fieldname in (
			...
			from kanierp.selling.doctype.sales_order.sales_order import update_produced_qty_in_so_item
...
def make_stock_return_entry(work_order):
	from kanierp.stock.doctype.stock_entry.stock_entry import get_available_materials

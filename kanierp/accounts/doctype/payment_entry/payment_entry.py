...
from kanierp.accounts.doctype.bank_account.bank_account import (
...
from kanierp.accounts.party import complete_contact_details, get_party_account, set_contact_details
...
from kanierp.controllers.accounts_controller import (
	AccountsController,
...
class PaymentEntry(AccountsController):
	...
	def update_payment_requests(self, cancel=False):
		from kanierp.accounts.doctype.payment_request.payment_request import (
...
def get_reference_details(
	...
	company_currency = ref_doc.get("company_currency") or kanierp.get_company_currency(ref_doc.company)

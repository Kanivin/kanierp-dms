...
from kanierp.accounts.doctype.payment_entry.payment_entry import (
...
from kanierp.accounts.doctype.sales_invoice.test_sales_invoice import (
...
class TestPaymentEntry(KanivinTestCase):
	def tearDown(self):
		frappe.db.rollback()
	...
	def test_payment_entry_retrieves_last_exchange_rate(self):
		from kanierp.setup.doctype.currency_exchange.test_currency_exchange import (
			save_new_records,
			test_records,
		)

...
from kanierp.controllers.status_updater import StatusUpdater
...
class POSClosingEntry(StatusUpdater):
	...
	if TYPE_CHECKING:
		...
		from kanierp.accounts.doctype.pos_closing_entry_detail.pos_closing_entry_detail import (
			POSClosingEntryDetail,
		)
		from kanierp.accounts.doctype.pos_closing_entry_taxes.pos_closing_entry_taxes import (
			POSClosingEntryTaxes,
		)
		from kanierp.accounts.doctype.pos_invoice_reference.pos_invoice_reference import (
			POSInvoiceReference,
		)
	...
	def get_payment_reconciliation_details(self):
		...
		return frappe.render_template(
			"kanierp/accounts/doctype/pos_closing_entry/closing_voucher_details.html",

...
from kanierp.accounts.doctype.loyalty_program.loyalty_program import validate_loyalty_points
from kanierp.accounts.doctype.payment_request.payment_request import make_payment_request
...
from kanierp.controllers.queries import item_query as _item_query
...
class POSInvoice(SalesInvoice):
	...
	if TYPE_CHECKING:
		...
		from kanierp.accounts.doctype.pos_invoice_item.pos_invoice_item import POSInvoiceItem

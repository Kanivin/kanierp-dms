...
from kanierp.accounts.doctype.pos_invoice.pos_invoice import PartialPaymentValidationError, make_sales_return
...
class TestPOSInvoice(unittest.TestCase):
	...
	def test_loyalty_points(self):
		...
		from kanierp.accounts.doctype.loyalty_program.test_loyalty_program import create_records
	...
	def test_merging_into_sales_invoice_with_discount(self):
		from kanierp.accounts.doctype.pos_closing_entry.test_pos_closing_entry import (
	...
	def test_ignore_pricing_rule(self):
		from kanierp.accounts.doctype.pricing_rule.test_pricing_rule import make_pricing_rule
	...
	def test_delivered_serial_no_case(self):
		from kanierp.accounts.doctype.pos_invoice_merge_log.test_pos_invoice_merge_log import (
			init_user_and_profile,
		)

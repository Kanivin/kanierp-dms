...
from kanierp.accounts.doctype.journal_entry.journal_entry import StockAccountInvalidTransaction
from kanierp.exceptions import InvalidAccountCurrency
...
class TestJournalEntry(unittest.TestCase):
	...
	def test_reverse_journal_entry(self):
		from kanierp.accounts.doctype.journal_entry.journal_entry import make_reverse_journal_entry

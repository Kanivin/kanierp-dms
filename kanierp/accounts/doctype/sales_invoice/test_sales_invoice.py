...
import kanierp
from kanierp.accounts.doctype.account.test_account import create_account, get_inventory_account
from kanierp.accounts.doctype.pos_profile.test_pos_profile import make_pos_profile
from kanierp.accounts.doctype.purchase_invoice.purchase_invoice import WarehouseMissingError
from kanierp.accounts.doctype.purchase_invoice.test_purchase_invoice import (
	unlink_payment_on_cancel_of_invoice,
)
from kanierp.accounts.doctype.sales_invoice.sales_invoice import make_inter_company_transaction
from kanierp.accounts.utils import PaymentEntryUnlinkError
from kanierp.assets.doctype.asset.depreciation import post_depreciation_entries
from kanierp.assets.doctype.asset.test_asset import create_asset, create_asset_data
from kanierp.assets.doctype.asset_depreciation_schedule.asset_depreciation_schedule import (
	get_depr_schedule,
)
from kanierp.controllers.accounts_controller import update_invoice_status
from kanierp.controllers.taxes_and_totals import get_itemised_tax_breakup_data
from kanierp.exceptions import InvalidAccountCurrency, InvalidCurrency
from kanierp.selling.doctype.customer.test_customer import get_customer_dict
from kanierp.stock.doctype.delivery_note.delivery_note import make_sales_invoice
from kanierp.stock.doctype.item.test_item import create_item
from kanierp.stock.doctype.purchase_receipt.test_purchase_receipt import make_purchase_receipt
from kanierp.stock.doctype.serial_and_batch_bundle.test_serial_and_batch_bundle import (
	get_batch_from_bundle,
	get_serial_nos_from_bundle,
	make_serial_batch_bundle,
)
from kanierp.stock.doctype.stock_entry.test_stock_entry import (
	get_qty_after_transaction,
	make_stock_entry,
)
from kanierp.stock.doctype.stock_reconciliation.test_stock_reconciliation import (
	create_stock_reconciliation,
)
from kanierp.stock.get_item_details import get_item_tax_map
from kanierp.stock.utils import get_incoming_rate, get_stock_balance


class TestSalesInvoice(KanivinTestCase):
	def setUp(self):
		from kanierp.stock.doctype.stock_ledger_entry.test_stock_ledger_entry import create_items
	...
	def test_payment_entry_unlink_against_invoice(self):
		from kanierp.accounts.doctype.payment_entry.test_payment_entry import get_payment_entry
	...
	def test_payment(self):
		...
		from kanierp.accounts.doctype.journal_entry.test_journal_entry import (
	...
	def test_outstanding_on_cost_center_allocation(self):
		# setup cost centers
		from kanierp.accounts.doctype.cost_center.test_cost_center import create_cost_center
		from kanierp.accounts.doctype.cost_center_allocation.test_cost_center_allocation import (
	...
	def test_pos_returns_with_repayment(self):
		from kanierp.accounts.doctype.sales_invoice.sales_invoice import make_sales_return
	...
	def test_bin_details_of_packed_item(self):
		from kanierp.selling.doctype.product_bundle.test_product_bundle import make_product_bundle
	...
	def _insert_purchase_receipt(self):
		from kanierp.stock.doctype.purchase_receipt.test_purchase_receipt import (
	...
	def _insert_delivery_note(self):
		from kanierp.stock.doctype.delivery_note.test_delivery_note import (
	...
	def test_serialized(self):
		from kanierp.stock.doctype.stock_entry.test_stock_entry import make_serialized_item
	...
	def test_serial_numbers_against_delivery_note(self):
		...
		"""
		from kanierp.stock.doctype.delivery_note.test_delivery_note import create_delivery_note
		from kanierp.stock.doctype.stock_entry.test_stock_entry import make_serialized_item
	...
	def test_outstanding_amount_after_advance_payment_entry_cancellation(self):
		...
		from kanierp.selling.doctype.sales_order.test_sales_order import make_sales_order
	...
	def test_rounding_adjustment_3(self):
		from kanierp.accounts.doctype.accounting_dimension.test_accounting_dimension import (
			create_dimension,
			disable_dimension,
		)
	...
	def test_sales_invoice_with_shipping_rule(self):
		from kanierp.accounts.doctype.shipping_rule.test_shipping_rule import create_shipping_rule
	...
	def test_sales_invoice_with_project_link(self):
		from kanierp.projects.doctype.project.test_project import make_project
	...
	def test_inter_company_transaction_without_default_warehouse(self):
		...
		old_perpetual_inventory = kanierp.is_perpetual_inventory_enabled("_Test Company 1")
	...
	def test_additional_discount_for_sales_invoice_with_discount_accounting_enabled(self):
		from kanierp.accounts.doctype.repost_accounting_ledger.test_repost_accounting_ledger import (
	...
	def test_depreciation_on_return_of_sold_asset(self):
		from kanierp.controllers.sales_and_purchase_return import make_return_doc
	...
	def test_sales_invoice_against_supplier(self):
		from kanierp.accounts.doctype.opening_invoice_creation_tool.test_opening_invoice_creation_tool import (
			make_customer,
		)
		from kanierp.accounts.doctype.party_link.party_link import create_party_link
		from kanierp.buying.doctype.supplier.test_supplier import create_supplier
	...
	def test_gain_loss_with_advance_entry(self):
		from kanierp.accounts.doctype.journal_entry.test_journal_entry import make_journal_entry
	...
	def test_advance_entries_as_liability(self):
		from kanierp.accounts.doctype.payment_entry.test_payment_entry import create_payment_entry
	...
	def test_taxes_merging_from_delivery_note(self):
		...
		map_docs(
			method="kanierp.stock.doctype.delivery_note.delivery_note.make_sales_invoice",
	...
	def test_common_party_with_foreign_currency_jv(self):
		from kanierp.accounts.doctype.account.test_account import create_account
		from kanierp.accounts.doctype.opening_invoice_creation_tool.test_opening_invoice_creation_tool import (
			make_customer,
		)
		from kanierp.accounts.doctype.party_link.party_link import create_party_link
		from kanierp.buying.doctype.supplier.test_supplier import create_supplier
		from kanierp.setup.utils import get_exchange_rate
	...
	def test_prevents_fully_returned_invoice_with_zero_quantity(self):
		from kanierp.controllers.sales_and_purchase_return import StockOverReturnError, make_return_doc
...
def create_internal_parties():
	from kanierp.selling.doctype.customer.test_customer import create_internal_customer

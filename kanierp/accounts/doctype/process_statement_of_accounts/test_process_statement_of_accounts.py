...
from kanierp.accounts.doctype.process_statement_of_accounts.process_statement_of_accounts import (
	get_statement_dict,
	send_emails,
)
...
class TestProcessStatementOfAccounts(AccountsTestMixin, KanivinTestCase):
	def setUp(self):
		self.create_company()

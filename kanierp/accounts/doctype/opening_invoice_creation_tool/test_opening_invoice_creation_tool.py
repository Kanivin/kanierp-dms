...
from kanierp.accounts.doctype.opening_invoice_creation_tool.opening_invoice_creation_tool import (
...
class TestOpeningInvoiceCreationTool(KanivinTestCase):
	@classmethod
	def setUpClass(self):
	...
	def test_opening_sales_invoice_creation_with_missing_debit_account(self):
		...
		error_log = frappe.db.exists(
			"Error Log",
			{"error": ["like", "%kanierp.controllers.accounts_controller.AccountMissingError%"]},
		)

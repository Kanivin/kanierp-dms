...
from kanierp.accounts.doctype.payment_entry.payment_entry import get_payment_entry
from kanierp.buying.doctype.purchase_order.purchase_order import get_mapped_purchase_invoice
from kanierp.buying.doctype.purchase_order.purchase_order import make_purchase_invoice as make_pi_from_po
...
from kanierp.controllers.accounts_controller import get_payment_terms
from kanierp.controllers.buying_controller import QtyMismatchError
from kanierp.exceptions import InvalidCurrency
...
from kanierp.stock.doctype.material_request.material_request import make_purchase_order
from kanierp.stock.doctype.material_request.test_material_request import make_material_request
...
from kanierp.stock.doctype.stock_entry.test_stock_entry import get_qty_after_transaction
from kanierp.stock.tests.test_utils import StockTestMixin

test_dependencies = ["Item", "Cost Center", "Payment Term", "Payment Terms Template"]
test_ignore = ["Serial No"]


class TestPurchaseInvoice(KanivinTestCase, StockTestMixin):
	@classmethod
	def setUpClass(self):
	...
	def test_update_received_qty_in_material_request(self):
		from kanierp.buying.doctype.purchase_order.purchase_order import make_purchase_invoice
	...
	def test_gl_entries_without_perpetual_inventory(self):
		...
		self.assertTrue(not cint(kanierp.is_perpetual_inventory_enabled(pi.company)))
		pi.insert()
		pi.submit()
	...
	def test_gl_entries_with_perpetual_inventory(self):
		...
		self.assertTrue(cint(kanierp.is_perpetual_inventory_enabled(pi.company)), 1)
	...
	def test_debit_note(self):
		from kanierp.accounts.doctype.payment_entry.test_payment_entry import get_payment_entry
		from kanierp.accounts.doctype.sales_invoice.test_sales_invoice import get_outstanding_amount
	...
	def test_offsetting_entries_for_accounting_dimensions(self):
		...
		from kanierp.accounts.report.trial_balance.test_trial_balance import (
	...
	def test_make_pr_and_pi_from_po(self):
		from kanierp.assets.doctype.asset.test_asset import create_asset_category

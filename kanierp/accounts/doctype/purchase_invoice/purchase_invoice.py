...
from kanierp.accounts.general_ledger import (
	get_round_off_account_and_cost_center,
	make_gl_entries,
	make_reverse_gl_entries,
	merge_similar_entries,
)
from kanierp.accounts.party import get_due_date, get_party_account
from kanierp.accounts.utils import get_account_currency, get_fiscal_year, update_voucher_outstanding
from kanierp.assets.doctype.asset.asset import is_cwip_accounting_enabled
from kanierp.assets.doctype.asset_category.asset_category import get_asset_category_account
from kanierp.buying.utils import check_on_hold_or_closed_status
from kanierp.controllers.accounts_controller import validate_account_head
from kanierp.controllers.buying_controller import BuyingController
...
class PurchaseInvoice(BuyingController):
	...
	if TYPE_CHECKING:
		...
		from kanierp.accounts.doctype.advance_tax.advance_tax import AdvanceTax
		...
		from kanierp.accounts.doctype.purchase_invoice_advance.purchase_invoice_advance import (
			PurchaseInvoiceAdvance,
		)
		from kanierp.accounts.doctype.purchase_invoice_item.purchase_invoice_item import PurchaseInvoiceItem
		from kanierp.accounts.doctype.purchase_taxes_and_charges.purchase_taxes_and_charges import (
			PurchaseTaxesandCharges,
		)
		from kanierp.accounts.doctype.tax_withheld_vouchers.tax_withheld_vouchers import TaxWithheldVouchers
		from kanierp.buying.doctype.purchase_receipt_item_supplied.purchase_receipt_item_supplied import (
	...
	def get_gl_entries(self, warehouse_account=None):
		self.auto_accounting_for_stock = kanierp.is_perpetual_inventory_enabled(self.company)
	...
	def update_billing_status_in_pr(self, update_modified=True):
		...
		for pr in set(updated_pr):
			from kanierp.stock.doctype.purchase_receipt.purchase_receipt import update_billing_percentage

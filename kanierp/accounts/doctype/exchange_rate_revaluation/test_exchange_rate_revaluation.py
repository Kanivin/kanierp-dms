...
class TestExchangeRateRevaluation(AccountsTestMixin, KanivinTestCase):
	def setUp(self):
		self.create_company()
	...
	def test_04_get_account_details_function(self):
		...
		from kanierp.accounts.doctype.exchange_rate_revaluation.exchange_rate_revaluation import (
			get_account_details,
		)

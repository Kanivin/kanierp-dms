...
class AccountingDimensionFilter(Document):
	...
	if TYPE_CHECKING:
		...
		from kanierp.accounts.doctype.allowed_dimension.allowed_dimension import AllowedDimension
		from kanierp.accounts.doctype.applicable_on_account.applicable_on_account import (
			ApplicableOnAccount,
		)

...
from kanierp.stock.doctype.purchase_receipt.test_purchase_receipt import get_gl_entries, make_purchase_receipt


class TestRepostAccountingLedger(AccountsTestMixin, KanivinTestCase):
	def setUp(self):
		self.create_company()

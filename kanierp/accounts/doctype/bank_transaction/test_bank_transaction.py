...
from kanierp.accounts.doctype.bank_reconciliation_tool.bank_reconciliation_tool import (
	get_linked_payments,
	reconcile_vouchers,
)
...
from kanierp.tests.utils import if_lending_app_installed

test_dependencies = ["Item", "Cost Center"]


class TestBankTransaction(KanivinTestCase):
	def setUp(self):
		for dt in [
			"Bank Transaction",
			"Payment Entry",
	...
	# This test checks if kanierp is able to provide a linked payment for a bank transaction based on the amount of the bank transaction.
	...
	# Check if kanierp can correctly filter a linked payments based on the debit/credit amount

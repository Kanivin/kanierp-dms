...
class PromotionalScheme(Document):
	...
	if TYPE_CHECKING:
		...
		from kanierp.accounts.doctype.campaign_item.campaign_item import CampaignItem
		from kanierp.accounts.doctype.customer_group_item.customer_group_item import CustomerGroupItem
		from kanierp.accounts.doctype.customer_item.customer_item import CustomerItem
		from kanierp.accounts.doctype.pricing_rule_brand.pricing_rule_brand import PricingRuleBrand
		from kanierp.accounts.doctype.pricing_rule_item_code.pricing_rule_item_code import (
			PricingRuleItemCode,
		)
		from kanierp.accounts.doctype.pricing_rule_item_group.pricing_rule_item_group import (
			PricingRuleItemGroup,
		)
		from kanierp.accounts.doctype.promotional_scheme_price_discount.promotional_scheme_price_discount import (
			PromotionalSchemePriceDiscount,
		)
		from kanierp.accounts.doctype.promotional_scheme_product_discount.promotional_scheme_product_discount import (
			PromotionalSchemeProductDiscount,
		)
		from kanierp.accounts.doctype.sales_partner_item.sales_partner_item import SalesPartnerItem
		from kanierp.accounts.doctype.supplier_group_item.supplier_group_item import SupplierGroupItem
		from kanierp.accounts.doctype.supplier_item.supplier_item import SupplierItem
		from kanierp.accounts.doctype.territory_item.territory_item import TerritoryItem

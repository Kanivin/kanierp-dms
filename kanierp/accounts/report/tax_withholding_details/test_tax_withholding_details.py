...
from kanierp.accounts.doctype.tax_withholding_category.test_tax_withholding_category import (
	create_tax_withholding_category,
)
from kanierp.accounts.report.tax_withholding_details.tax_withholding_details import execute
from kanierp.accounts.test.accounts_mixin import AccountsTestMixin
from kanierp.accounts.utils import get_fiscal_year


class TestTaxWithholdingDetails(AccountsTestMixin, KanivinTestCase):
	def setUp(self):
		self.create_company()

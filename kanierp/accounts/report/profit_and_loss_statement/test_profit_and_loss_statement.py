...
from kanierp.accounts.report.financial_statements import get_period_list
from kanierp.accounts.report.profit_and_loss_statement.profit_and_loss_statement import execute
from kanierp.accounts.test.accounts_mixin import AccountsTestMixin


class TestProfitAndLossStatement(AccountsTestMixin, KanivinTestCase):
	def setUp(self):
		self.create_company()

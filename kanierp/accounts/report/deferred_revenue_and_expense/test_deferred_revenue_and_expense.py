...
from kanierp.accounts.report.deferred_revenue_and_expense.deferred_revenue_and_expense import (
...
class TestDeferredRevenueAndExpense(KanivinTestCase, AccountsTestMixin):
	@classmethod
	def setUpClass(self):
		self.maxDiff = None

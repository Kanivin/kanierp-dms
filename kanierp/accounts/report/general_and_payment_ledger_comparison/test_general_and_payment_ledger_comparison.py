...
from kanierp.accounts.report.general_and_payment_ledger_comparison.general_and_payment_ledger_comparison import (
	execute,
)
from kanierp.accounts.test.accounts_mixin import AccountsTestMixin


class TestGeneralAndPaymentLedger(KanivinTestCase, AccountsTestMixin):
	def setUp(self):
		self.create_company()
		self.cleanup()

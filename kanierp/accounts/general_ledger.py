...
from kanierp.accounts.doctype.accounting_dimension_filter.accounting_dimension_filter import (
	get_dimension_filter_map,
)
from kanierp.accounts.doctype.accounting_period.accounting_period import ClosedAccountingPeriod
from kanierp.accounts.doctype.budget.budget import validate_expense_against_budget
from kanierp.accounts.utils import create_payment_ledger_entry
from kanierp.exceptions import InvalidAccountDimensionError, MandatoryAccountDimensionError
...
def merge_similar_entries(gl_map, precision=None):
	...
	company = gl_map[0].company if gl_map else kanierp.get_default_company()

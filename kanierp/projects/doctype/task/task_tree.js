...
frappe.treeview_settings["Task"] = {
	get_tree_nodes: "kanierp.projects.doctype.task.task.get_children",
	add_tree_node: "kanierp.projects.doctype.task.task.add_node",
	filters: [
		{
			fieldname: "project",
			fieldtype: "Link",
			...
			click: function (node) {
				...
				const dialog = new frappe.ui.Dialog({
					...
					primary_action: function () {
						dialog.hide();
						return frappe.call({
							method: "kanierp.projects.doctype.task.task.add_multiple_tasks",
							args: {

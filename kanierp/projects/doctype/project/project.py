...
from kanierp.controllers.queries import get_filters_cond
from kanierp.controllers.website_list_for_contact import get_customers_suppliers
from kanierp.setup.doctype.holiday_list.holiday_list import is_holiday
...
class Project(Document):
	...
	if TYPE_CHECKING:
		...
		from kanierp.projects.doctype.project_user.project_user import ProjectUser

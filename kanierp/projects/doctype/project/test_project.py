...
from kanierp.projects.doctype.project_template.test_project_template import make_project_template
from kanierp.projects.doctype.task.test_task import create_task
from kanierp.selling.doctype.sales_order.sales_order import make_project as make_project_from_so
...
class TestProject(KanivinTestCase):

...
kanierp.maintenance.MaintenanceSchedule = class MaintenanceSchedule extends frappe.ui.form.Controller {
	refresh() {
...
extend_cscript(cur_frm.cscript, new kanierp.maintenance.MaintenanceSchedule({ frm: cur_frm }));

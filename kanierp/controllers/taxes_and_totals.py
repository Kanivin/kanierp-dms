...
import kanierp
from kanierp.accounts.doctype.journal_entry.journal_entry import get_exchange_rate
from kanierp.accounts.doctype.pricing_rule.utils import get_applied_pricing_rules
from kanierp.controllers.accounts_controller import (
	validate_conversion_rate,
	validate_inclusive_tax,
	validate_taxes_and_charges,
)
from kanierp.stock.get_item_details import _get_item_tax_template, get_item_tax_map
...
class calculate_taxes_and_totals:
	...
	def validate_conversion_rate(self):
		...
		company_currency = kanierp.get_company_currency(self.doc.company)

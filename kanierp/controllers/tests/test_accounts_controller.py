...
from kanierp.buying.doctype.purchase_order.test_purchase_order import prepare_data_for_internal_transfer
...
class TestAccountsController(KanivinTestCase):
	"""
	...
	def test_16_internal_transfer_at_arms_length_price(self):
		from kanierp.accounts.doctype.sales_invoice.sales_invoice import make_inter_company_purchase_invoice
	...
	def test_party_billing_and_shipping_address(self):
		from kanierp.crm.doctype.prospect.test_prospect import make_address

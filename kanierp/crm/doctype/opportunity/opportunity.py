...
class Opportunity(TransactionBase, CRMNote):
	...
	if TYPE_CHECKING:
		...
		from kanierp.crm.doctype.crm_note.crm_note import CRMNote
		from kanierp.crm.doctype.opportunity_item.opportunity_item import OpportunityItem
		from kanierp.crm.doctype.opportunity_lost_reason_detail.opportunity_lost_reason_detail import (
...
def make_quotation(source_name, target_doc=None):
	def set_missing_values(source, target):
		from kanierp.controllers.accounts_controller import get_default_taxes_and_charges
...
def make_opportunity_from_communication(communication, company, ignore_communication_links=False):
	from kanierp.crm.doctype.lead.lead import make_lead_from_communication

...
from kanierp.stock.deprecated_serial_batch import (
	DeprecatedBatchNoValuation,
	DeprecatedSerialNoValuation,
)
from kanierp.stock.valuation import round_off_if_near_zero
...
class SerialBatchBundle:
	...
	def make_serial_batch_no_bundle_for_material_transfer(self):
		from kanierp.controllers.stock_controller import make_bundle_for_material_transfer
	...
	def set_warehouse_and_status_in_serial_nos(self):
		from kanierp.stock.doctype.serial_no.serial_no import get_serial_nos as get_parsed_serial_nos
...
class BatchNoValuation(DeprecatedBatchNoValuation):
	...
	def prepare_batches(self):
		from kanierp.stock.utils import get_valuation_method

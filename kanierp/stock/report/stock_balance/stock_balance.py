...
from kanierp.stock.doctype.warehouse.warehouse import apply_warehouse_filter
from kanierp.stock.report.stock_ageing.stock_ageing import FIFOSlots, get_average_age
from kanierp.stock.utils import add_additional_uom_columns
...
class StockBalanceReport:
	...
	def set_company_currency(self) -> None:
		if self.filters.get("company"):
			self.company_currency = kanierp.get_company_currency(self.filters.get("company"))
		else:

...
from kanierp.stock.utils import check_pending_reposting
...
class StockSettings(Document):
	...
	def validate(self):
		...
		from kanierp.utilities.naming import set_by_naming_series
	...
	def validate_clean_description_html(self):
		if int(self.clean_description_html or 0) and not int(self.db_get("clean_description_html") or 0):
			# changed to text
			frappe.enqueue(
				"kanierp.stock.doctype.stock_settings.stock_settings.clean_all_descriptions",

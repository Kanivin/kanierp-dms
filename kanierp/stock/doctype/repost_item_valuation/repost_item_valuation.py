...
import kanierp
from kanierp.accounts.general_ledger import validate_accounting_period
from kanierp.accounts.utils import get_future_stock_vouchers, repost_gle_for_stock_vouchers
from kanierp.stock.stock_ledger import (
...
def repost_gl_entries(doc):
	if not cint(kanierp.is_perpetual_inventory_enabled(doc.company)):
		return

...
from kanierp.stock.doctype.warehouse.warehouse import convert_to_group_or_ledger, get_children

test_records = frappe.get_test_records("Warehouse")


class TestWarehouse(KanivinTestCase):
	def setUp(self):
		super().setUp()
...
def create_warehouse(warehouse_name, properties=None, company=None):
	...
	warehouse_id = kanierp.encode_company_abbr(warehouse_name, company)

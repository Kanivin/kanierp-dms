...
from kanierp.controllers.item_variant import ItemTemplateCannotHaveStock
from kanierp.stock.doctype.inventory_dimension.inventory_dimension import get_inventory_dimensions
from kanierp.stock.serial_batch_bundle import SerialBatchBundle
...
class StockLedgerEntry(Document):
	...
	def set_posting_datetime(self):
		from kanierp.stock.utils import get_combine_datetime
	...
	def validate_and_set_fiscal_year(self):
		if not self.fiscal_year:
			...
			from kanierp.accounts.utils import validate_fiscal_year
	...
	def block_transactions_against_group_warehouse(self):
		from kanierp.stock.utils import is_group_warehouse

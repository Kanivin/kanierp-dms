...
from kanierp.accounts.doctype.gl_entry.gl_entry import rename_gle_sle_docs
...
from kanierp.stock.doctype.stock_ledger_entry.stock_ledger_entry import BackDatedStockTransaction
...
class TestStockLedgerEntry(KanivinTestCase, StockTestMixin):
	def setUp(self):
		items = create_items()
		reset("Stock Entry")
	...
	def test_tie_breaking(self):
		from kanierp.stock.doctype.repost_item_valuation.repost_item_valuation import repost_entries
	...
	def test_negative_qty_with_precision(self):
		...
		from kanierp.stock.utils import get_stock_balance
...
class TestDeferredNaming(KanivinTestCase):
	@classmethod

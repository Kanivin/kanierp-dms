...
from kanierp.stock.doctype.stock_ledger_entry.stock_ledger_entry import InventoryDimensionNegativeStockError
from kanierp.stock.doctype.warehouse.test_warehouse import create_warehouse


class TestInventoryDimension(KanivinTestCase):
	def setUp(self):
		prepare_test_data()

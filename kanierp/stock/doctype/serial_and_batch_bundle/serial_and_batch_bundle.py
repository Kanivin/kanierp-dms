...
class SerialandBatchBundle(Document):
	...
	if TYPE_CHECKING:
		...
		from kanierp.stock.doctype.serial_and_batch_entry.serial_and_batch_entry import SerialandBatchEntry
...
def get_reserved_serial_nos_for_pos(kwargs):
	from kanierp.controllers.sales_and_purchase_return import get_returned_serial_nos
	from kanierp.stock.doctype.serial_no.serial_no import get_serial_nos

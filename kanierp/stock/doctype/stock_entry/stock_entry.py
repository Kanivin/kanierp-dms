...
import kanierp
from kanierp.accounts.general_ledger import process_gl_map
from kanierp.buying.utils import check_on_hold_or_closed_status
from kanierp.controllers.taxes_and_totals import init_landed_taxes_and_totals
from kanierp.manufacturing.doctype.bom.bom import (
	add_additional_cost,
	get_op_cost_from_sub_assemblies,
	get_scrap_items_from_sub_assemblies,
	validate_bom_no,
)
from kanierp.setup.doctype.brand.brand import get_brand_defaults
from kanierp.setup.doctype.item_group.item_group import get_item_group_defaults
from kanierp.stock.doctype.batch.batch import get_batch_qty
from kanierp.stock.doctype.item.item import get_item_defaults
from kanierp.stock.doctype.serial_no.serial_no import get_serial_nos
from kanierp.stock.doctype.stock_reconciliation.stock_reconciliation import (
	OpeningEntryAccountError,
)
from kanierp.stock.get_item_details import (
	get_barcode_data,
	get_bin_details,
	get_conversion_factor,
	get_default_cost_center,
)
from kanierp.stock.serial_batch_bundle import (
	SerialBatchCreation,
	get_empty_batches_based_work_order,
	get_serial_or_batch_items,
)
from kanierp.stock.stock_ledger import NegativeStockError, get_previous_sle, get_valuation_rate
from kanierp.stock.utils import get_bin, get_incoming_rate
...
from kanierp.controllers.stock_controller import StockController
...
class StockEntry(StockController):
	...
	if TYPE_CHECKING:
		...
		from kanierp.stock.doctype.landed_cost_taxes_and_charges.landed_cost_taxes_and_charges import (
			LandedCostTaxesandCharges,
		)
		from kanierp.stock.doctype.stock_entry_detail.stock_entry_detail import StockEntryDetail
	...
	def before_validate(self):
		from kanierp.stock.doctype.putaway_rule.putaway_rule import apply_putaway_rule
	...
	def validate_difference_account(self):
		if not cint(kanierp.is_perpetual_inventory_enabled(self.company)):
			return
	...
	def set_actual_qty(self):
		from kanierp.stock.stock_ledger import is_negative_stock_allowed
		...
		for d in self.get("items"):
			...
			if not d.basic_rate and not d.allow_zero_valuation_rate:
				...
				d.basic_rate = get_valuation_rate(
					...
					currency=kanierp.get_company_currency(self.company),
					company=self.company,
	...
	def get_bom_raw_materials(self, qty):
		from kanierp.manufacturing.doctype.bom.bom import get_bom_items_as_dict
	...
	def update_subcontracting_order_status(self):
		if self.subcontracting_order and self.purpose in ["Send to Subcontractor", "Material Transfer"]:
			from kanierp.subcontracting.doctype.subcontracting_order.subcontracting_order import (
	...
	def update_pick_list_status(self):
		from kanierp.stock.doctype.pick_list.pick_list import update_pick_list_status
...
def move_sample_to_retention_warehouse(company, items):
	...
	from kanierp.stock.serial_batch_bundle import SerialBatchCreation
...
def get_expired_batch_items():
	from kanierp.stock.doctype.serial_and_batch_bundle.serial_and_batch_bundle import get_auto_batch_nos
...
def get_items_from_subcontract_order(source_name, target_doc=None):
	from kanierp.controllers.subcontracting_controller import make_rm_stock_entry

...
from kanierp.selling.doctype.sales_order.sales_order import create_pick_list
...
from kanierp.stock.doctype.packed_item.test_packed_item import create_product_bundle
...
class TestPickList(KanivinTestCase):

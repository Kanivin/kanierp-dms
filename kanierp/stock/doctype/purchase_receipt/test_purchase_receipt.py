...
import kanierp
from kanierp.accounts.doctype.account.test_account import get_inventory_account
from kanierp.buying.doctype.supplier.test_supplier import create_supplier
from kanierp.controllers.buying_controller import QtyMismatchError
from kanierp.stock import get_warehouse_account_map
from kanierp.stock.doctype.item.test_item import create_item, make_item
from kanierp.stock.doctype.purchase_receipt.purchase_receipt import make_purchase_invoice
from kanierp.stock.doctype.serial_and_batch_bundle.serial_and_batch_bundle import (
...
from kanierp.stock.doctype.serial_no.serial_no import get_serial_nos
from kanierp.stock.doctype.warehouse.test_warehouse import create_warehouse


class TestPurchaseReceipt(KanivinTestCase):
	def setUp(self):
	...
	def test_make_purchase_invoice(self):
		from kanierp.accounts.doctype.payment_entry.test_payment_entry import create_payment_term
	...
	def test_purchase_receipt_no_gl_entry(self):
		from kanierp.stock.doctype.stock_entry.test_stock_entry import make_stock_entry
	...
	def test_purchase_receipt_gl_entry(self):
		...
		self.assertEqual(cint(kanierp.is_perpetual_inventory_enabled(pr.company)), 1)
	...
	def test_purchase_return_for_rejected_qty(self):
		from kanierp.stock.doctype.warehouse.test_warehouse import get_warehouse
	...
	def test_closed_purchase_receipt(self):
		from kanierp.stock.doctype.purchase_receipt.purchase_receipt import (
	...
	def test_pr_billing_status(self):
		...
		3. PO -> PR2.
		"""
		from kanierp.buying.doctype.purchase_order.purchase_order import (
			make_purchase_invoice as make_purchase_invoice_from_po,
		)
		from kanierp.buying.doctype.purchase_order.purchase_order import make_purchase_receipt
		from kanierp.buying.doctype.purchase_order.test_purchase_order import create_purchase_order
	...
	def test_purchase_return_with_submitted_asset(self):
		from kanierp.stock.doctype.purchase_receipt.purchase_receipt import make_purchase_return
	...
	def test_make_purchase_invoice_from_pr_for_returned_qty(self):
		from kanierp.buying.doctype.purchase_order.test_purchase_order import (
	...
	def test_stock_transfer_from_purchase_receipt(self):
		from kanierp.stock.doctype.delivery_note.delivery_note import make_inter_company_purchase_receipt
		from kanierp.stock.doctype.delivery_note.test_delivery_note import create_delivery_note
	...
	def test_po_to_pi_and_po_to_pr_worflow_full(self):
		...
		"""
		from kanierp.buying.doctype.purchase_order import purchase_order, test_purchase_order
	...
	def test_purchase_receipt_with_exchange_rate_difference(self):
		from kanierp.accounts.doctype.purchase_invoice.purchase_invoice import (
		...
		from kanierp.accounts.party import add_party_account
	...
	def test_payment_terms_are_fetched_when_creating_purchase_invoice(self):
		from kanierp.accounts.doctype.payment_entry.test_payment_entry import (
			create_payment_terms_template,
		)
		from kanierp.accounts.doctype.purchase_invoice.test_purchase_invoice import make_purchase_invoice
		from kanierp.buying.doctype.purchase_order.test_purchase_order import (
			create_purchase_order,
			make_pr_against_po,
		)
		from kanierp.selling.doctype.sales_order.test_sales_order import (
	...
	def test_neg_to_positive(self):
		from kanierp.stock.doctype.stock_entry.stock_entry_utils import make_stock_entry
	...
	def test_backdated_transaction_for_internal_transfer_in_trasit_warehouse_for_purchase_invoice(
		...
		from kanierp.accounts.doctype.sales_invoice.sales_invoice import (
			make_inter_company_purchase_invoice,
		)
		from kanierp.accounts.doctype.sales_invoice.test_sales_invoice import create_sales_invoice
	...
	def test_disable_last_purchase_rate(self):
		from kanierp.stock.get_item_details import get_item_details
	...
	def test_purchase_receipt_with_backdated_landed_cost_voucher(self):
		from kanierp.controllers.sales_and_purchase_return import make_return_doc
		from kanierp.stock.doctype.landed_cost_voucher.test_landed_cost_voucher import (
	...
	def test_pr_billed_amount_against_return_entry(self):
		from kanierp.accounts.doctype.purchase_invoice.purchase_invoice import make_debit_note
		from kanierp.stock.doctype.purchase_receipt.purchase_receipt import (
	...
	def test_valuation_taxes_lcv_repost_after_billing(self):
		...
		old_perpetual_inventory = kanierp.is_perpetual_inventory_enabled("_Test Company")
	...
	def test_sles_with_same_posting_datetime_and_creation(self):
		from kanierp.stock.doctype.stock_entry.test_stock_entry import make_stock_entry
		from kanierp.stock.report.stock_balance.stock_balance import execute
...
def prepare_data_for_internal_transfer():
	from kanierp.accounts.doctype.sales_invoice.test_sales_invoice import create_internal_supplier

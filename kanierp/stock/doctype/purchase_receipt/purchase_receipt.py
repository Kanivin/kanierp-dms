...
import kanierp
from kanierp.accounts.utils import get_account_currency
from kanierp.assets.doctype.asset.asset import get_asset_account, is_cwip_accounting_enabled
from kanierp.buying.utils import check_on_hold_or_closed_status
from kanierp.controllers.accounts_controller import merge_taxes
from kanierp.controllers.buying_controller import BuyingController
from kanierp.stock.doctype.delivery_note.delivery_note import make_inter_company_transaction
...
class PurchaseReceipt(BuyingController):
	...
	if TYPE_CHECKING:
		...
		from kanierp.stock.doctype.purchase_receipt_item.purchase_receipt_item import PurchaseReceiptItem
	...
	def make_item_gl_entries(self, gl_entries, warehouse_account=None):
		...
		for d in self.get("items"):
			if (
				...
				if not (
					(kanierp.is_perpetual_inventory_enabled(self.company) and d.item_code in stock_items)
...
def make_purchase_invoice(source_name, target_doc=None, args=None):
	from kanierp.accounts.party import get_payment_terms_template

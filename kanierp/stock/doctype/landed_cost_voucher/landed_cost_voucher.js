...
kanierp.landed_cost_taxes_and_charges.setup_triggers("Landed Cost Voucher");
kanierp.stock.LandedCostVoucher = class LandedCostVoucher extends kanierp.stock.StockController {
	setup() {
		var me = this;
...
cur_frm.script_manager.make(kanierp.stock.LandedCostVoucher);

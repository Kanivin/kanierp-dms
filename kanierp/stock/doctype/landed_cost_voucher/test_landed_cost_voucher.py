...
from kanierp.accounts.utils import update_gl_entries_after
from kanierp.assets.doctype.asset.test_asset import create_asset_category, create_fixed_asset_item
...
class TestLandedCostVoucher(KanivinTestCase):

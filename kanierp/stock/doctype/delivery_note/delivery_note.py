...
from kanierp.controllers.accounts_controller import get_taxes_and_charges, merge_taxes
...
class DeliveryNote(SellingController):
	...
	if TYPE_CHECKING:
		...
		from kanierp.stock.doctype.delivery_note_item.delivery_note_item import DeliveryNoteItem

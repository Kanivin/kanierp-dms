...
from kanierp.selling.doctype.sales_order.sales_order import make_delivery_note, make_sales_invoice
from kanierp.selling.doctype.sales_order.test_sales_order import make_sales_order
from kanierp.selling.report.sales_order_analysis.sales_order_analysis import execute
...
class TestSalesOrderAnalysis(KanivinTestCase):

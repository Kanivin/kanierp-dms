...
from kanierp.selling.report.payment_terms_status_for_sales_order.payment_terms_status_for_sales_order import (
	execute,
)
...
class TestPaymentTermsStatusForSalesOrder(KanivinTestCase):
	def setUp(self):

...
from kanierp.accounts.test.accounts_mixin import AccountsTestMixin
from kanierp.controllers.accounts_controller import update_child_qty_rate
from kanierp.maintenance.doctype.maintenance_schedule.test_maintenance_schedule import (
	make_maintenance_schedule,
)
from kanierp.maintenance.doctype.maintenance_visit.test_maintenance_visit import (
...
from kanierp.stock.get_item_details import get_bin_details


class TestSalesOrder(AccountsTestMixin, KanivinTestCase):
	@classmethod
	def setUpClass(cls):
		super().setUpClass()
	...
	def test_drop_shipping(self):
		from kanierp.buying.doctype.purchase_order.purchase_order import update_status
		from kanierp.selling.doctype.sales_order.sales_order import (
			make_purchase_order_for_default_supplier,
		)
		from kanierp.selling.doctype.sales_order.sales_order import update_status as so_update_status
	...
	def test_product_bundles_in_so_are_replaced_with_bundle_items_in_po(self):
		...
		"""
		from kanierp.selling.doctype.sales_order.sales_order import make_purchase_order
	...
	def test_make_work_order(self):
		from kanierp.selling.doctype.sales_order.sales_order import get_work_order_items
	...
	def test_work_order_pop_up_from_sales_order(self):
		...
		from kanierp.controllers.item_variant import create_variant
		from kanierp.manufacturing.doctype.production_plan.test_production_plan import make_bom
		from kanierp.selling.doctype.sales_order.sales_order import get_work_order_items
	...
	def test_so_cancellation_after_work_order_submission(self):
		...
		Expected result: Sales Order should not get cancelled
		"""
		from kanierp.manufacturing.doctype.work_order.test_work_order import make_wo_order_test_record
	...
	def test_so_back_updated_from_wo_via_mr(self):
		...
		from kanierp.manufacturing.doctype.work_order.work_order import (
			make_stock_entry as make_se_from_wo,
		)
		from kanierp.stock.doctype.material_request.material_request import raise_work_orders
	...
	def test_pick_list_for_batch(self):
		from kanierp.stock.doctype.pick_list.pick_list import create_delivery_note

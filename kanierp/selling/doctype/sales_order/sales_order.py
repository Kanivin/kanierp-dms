...
from kanierp.accounts.party import get_party_account
from kanierp.controllers.selling_controller import SellingController
from kanierp.manufacturing.doctype.blanket_order.blanket_order import (
	validate_against_blanket_order,
)
from kanierp.manufacturing.doctype.production_plan.production_plan import (
...
from kanierp.stock.get_item_details import get_bin_details, get_default_bom, get_price_list_rate
from kanierp.stock.stock_balance import get_reserved_qty, update_bin_qty
...
class SalesOrder(SellingController):
	...
	if TYPE_CHECKING:
		...
		from kanierp.selling.doctype.sales_order_item.sales_order_item import SalesOrderItem
	...
	def validate(self):
		...
		if self.coupon_code:
			from kanierp.accounts.doctype.pricing_rule.utils import validate_coupon_code
	...
	def on_submit(self):
		...
		if self.coupon_code:
			from kanierp.accounts.doctype.pricing_rule.utils import update_coupon_code_count
...
def create_pick_list(source_name, target_doc=None):
	from kanierp.stock.doctype.packed_item.packed_item import is_product_bundle

...
from kanierp.accounts.party import get_due_date
from kanierp.exceptions import PartyDisabled, PartyFrozen
from kanierp.selling.doctype.customer.customer import (
	get_credit_limit,
	get_customer_outstanding,
	parse_full_name,
)
from kanierp.tests.utils import create_test_contact_and_address
...
class TestCustomer(KanivinTestCase):
	def setUp(self):
	...
	def test_party_details(self):
		from kanierp.accounts.party import get_party_details

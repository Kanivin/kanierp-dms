frappe.provide("kanierp.edi");

kanierp.edi.import_genericode = function (listview_or_form) {
	...
	new frappe.ui.FileUploader({
		method: "kanierp.edi.doctype.code_list.code_list_import.import_genericode",
		doctype: doctype,
		docname: docname,
...
function show_column_selection_dialog(context) {
	...
	let d = new frappe.ui.Dialog({
		...
		primary_action(values) {
			...
			frappe
				.xcall("kanierp.edi.doctype.code_list.code_list_import.process_genericode_import", {

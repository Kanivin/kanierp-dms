...
from kanierp.support.doctype.issue.issue import get_holidays
...
class ServiceLevelAgreement(Document):
	...
	if TYPE_CHECKING:
		...
		from kanierp.support.doctype.pause_sla_on_status.pause_sla_on_status import PauseSLAOnStatus
		from kanierp.support.doctype.service_day.service_day import ServiceDay
		from kanierp.support.doctype.service_level_priority.service_level_priority import (
			ServiceLevelPriority,
		)
		from kanierp.support.doctype.sla_fulfilled_on_status.sla_fulfilled_on_status import (

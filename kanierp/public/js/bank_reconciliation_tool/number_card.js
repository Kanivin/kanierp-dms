...
kanierp.accounts.bank_reconciliation.NumberCardManager = class NumberCardManager {
	constructor(opts) {
	...
	make_cards() {
		...
		chart_data.forEach((summary) => {
			let number_card = new kanierp.accounts.NumberCard(summary);
...
kanierp.accounts.NumberCard = class NumberCard {
	constructor(options) {

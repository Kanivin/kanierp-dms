frappe.provide("kanierp.timesheet");

kanierp.timesheet.timer = function (frm, row, timestamp = 0) {
	...
	kanierp.timesheet.control_timer(frm, dialog, row, timestamp);
	dialog.show();
};

kanierp.timesheet.control_timer = function (frm, dialog, row, timestamp = 0) {

...
def task(doc_name, from_doctype, to_doctype):
	from kanierp.accounts.doctype.payment_entry import payment_entry
	from kanierp.accounts.doctype.purchase_invoice import purchase_invoice
	from kanierp.accounts.doctype.sales_invoice import sales_invoice
	from kanierp.buying.doctype.purchase_order import purchase_order
	from kanierp.buying.doctype.supplier_quotation import supplier_quotation
	from kanierp.selling.doctype.quotation import quotation
	from kanierp.selling.doctype.sales_order import sales_order
	from kanierp.stock.doctype.delivery_note import delivery_note
	from kanierp.stock.doctype.purchase_receipt import purchase_receipt

...
class TestSubcontractingReceipt(KanivinTestCase):
	def setUp(self):
		make_subcontracted_items()
		make_raw_materials()
		make_service_items()
	...
	def test_subcontracting_over_receipt(self):
		...
		"""
		from kanierp.controllers.subcontracting_controller import (
	...
	def test_subcontracting_receipt_over_return(self):
		...
		from kanierp.controllers.status_updater import OverAllowanceError
	...
	def test_subcontracting_receipt_gl_entry(self):
		...
		self.assertEqual(cint(kanierp.is_perpetual_inventory_enabled(scr.company)), 1)
	...
	def test_quality_inspection_for_subcontracting_receipt(self):
		from kanierp.stock.doctype.quality_inspection.test_quality_inspection import (

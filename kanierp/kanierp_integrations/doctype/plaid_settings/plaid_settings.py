...
from kanierp.kanierp_integrations.doctype.plaid_settings.plaid_connector import PlaidConnector
...
def enqueue_synchronization():
	...
	for plaid_account in plaid_accounts:
		frappe.enqueue(
			"kanierp.kanierp_integrations.doctype.plaid_settings.plaid_settings.sync_transactions",
